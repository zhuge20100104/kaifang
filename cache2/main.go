...
import (
	...
	"github.com/zhuge20100104/kaifang/cache2/db"

	m "github.com/zhuge20100104/kaifang/cache2/models"
	"github.com/zhuge20100104/kaifang/cache2/utils"
)
...
func main() {
	...
	defer db.Db.CloseDB()
	// 初始化开房缓存对象
	kfMap = make(map[string]m.TimedData, 0)
